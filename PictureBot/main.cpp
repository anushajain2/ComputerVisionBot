...
//  PictureBot
//
//  Created by Anusha on 4/16/17.
//  Copyright © 2017 AnushaJain. All rights reserved.
//
...
int main(void )
{
    ...
    if(!faceCascade.load("/Users/an/Desktop/PictureBot/PictureBot/lbpcascade_frontalface.xml"))
    {
